...
const Copyrightsec = () => {
  return (
    <div className="self-stretch flex md:flex-row  flex-col md:pt-6 pt-4 px-0 pb-0 md:items-center  md:justify-between  gap-y-4 text-center text-neutral-800 border-t-[1px] border-solid border-gray-300">
      <div className="relative tracking-[-0.1px] leading-[24px]">
        © 2023 Lookscout. All Rights Reserved.
      </div>
      <div className="flex flex-row items-start md:justify-start  justify-center md:gap-[24px] gap-16">
