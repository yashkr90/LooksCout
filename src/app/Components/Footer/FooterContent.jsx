...
const FooterContent = () => {
  return (
    <div className="self-stretch grid lg:grid-cols-4 items-start lg:justify-between  md:gap-x-12 md:gap-y-8 sm:grid-cols-2 sm:gap-y-6 sm:gap-x-16">
      <div className="flex flex-col lg:order-1 sm:col-span-2 md:col-span-1 md:order-1  items-start justify-start gap-[16px] text-neutral-800">
      ...
      <div className="flex-1 flex flex-col lg:order-4 sm:col-span-2 md:col-span-1 md:order-2 items-start justify-start gap-[24px]">
        <div className="rounded-8xs overflow-hidden flex flex-row items-center justify-center">
          <div className="relative tracking-[-0.1px] leading-[24px] font-semibold">
