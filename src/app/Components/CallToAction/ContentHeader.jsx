...
const ContentHeader = () => {
  return (
    <div className="md:w-[752px] sm:w-full flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-start gap-[8px]">
        <div className="relative tracking-[-0.1px] leading-[20px] font-semibold text-sm">
          1% OF THE INDUSTRY
        </div>
        <div className="md:w-[752px] sm:w-full flex flex-col items-center justify-start gap-[16px] text-center text-13xl text-gray-700">
