...
const ContentHeader = () => {
  return (
    <div className="lg:w-[1280px]  w-full flex flex-col py-0 lg:px-8 box-border items-center justify-center">
      <div className="lg:w-[800px]  w-full flex flex-col items-center justify-center">
